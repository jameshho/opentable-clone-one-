...
export default async function handler(
  ...
  "In the next.js with prisma code above, i dont understand how 'restaurantIds['Vivaan - fine Indian']' is undefined. "
  ...
  //User
  const userChris = await prisma.user.create({
    data: {
      first_name: "Chris",
      last_name: "Evans",
  ...
  await prisma.review.createMany({
    data: [
      ...
      },
      {
        ...
        rating: 5,
        restaurant_id: restaurantIds['Sofia'],
        user_id: userJosh.id,
      },
      {
        first_name: "Josh",
...
//currently adding 3 tables per restaurant
  ...
  const booking1 = await prisma.booking.create({
    ...
    {
      number_of_people: 4,
      booking_time: new Date('2023-05-13T17:00:00Z'),
      booker_email: "james@gmail.com",
      booker_phone: "1112223333",
      booker_first_name: "James",
      booker_last_name: "Ho",
